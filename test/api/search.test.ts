...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search treats an unterminated quote as a literal search term', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not leak users via UNION SELECT with fixed columns', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not leak user credentials via UNION SELECT', async () => {
    const res = await request(app)
  ...
  void it('GET product search does not leak the database schema via UNION SELECT on sqlite_master', async () => {
    const res = await request(app)
